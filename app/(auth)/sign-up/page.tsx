...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (signUpError) {
      ...
      setError(
        isRateLimit
          ? "Too many sign-up attempts. Please wait about an hour and try again. For development, you can disable email confirmation in Supabase Dashboard → Authentication → Providers → Email."
          : signUpError.message
      );
      return;
    }
